...
Run the Rspec tests with command below:
...
```
This program is written and executed with Ruby version ruby 2.5.1p57
...
- The first valid command to the robot is a PLACE command, after that, any sequence of commands may 
  be issued, in any order, including another PLACE command- The applicaioon should discard all commands in the sequence until a valid PLACE command has been executed
